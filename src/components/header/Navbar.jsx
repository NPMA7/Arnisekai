export const NavbarAnime = () => {
    ...
    return (
      <div className="  bg-gray-700 py-3 fixed w-full z-10 md:top-20 sm:top-16 max-[640px]:top-16 top-96">
        ...
        <li className="flex-1">
          <a className="text-center block border border-blue-500 rounded py-2 sm:px-5 min-[490px]:px-5 max-[340px]:px-2 max-[455px]:pr-5  pl-4 pr-6 bg-blue-500 hover:bg-blue-700 text-white overflow-hidden" href="#">List Anime</a>
        </li>
        <li className="flex-1">
