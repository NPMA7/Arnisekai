    ...
    return (
      <div className="">
        <div className="hover:text-gray-30 flex justify-center cursor-pointer lg:pl-0">
          ...
          <div
            className="h-10 pt-56 text-gray-100 max-[600px]:pt-40  
          absolute "
          >
            {episode_rilis}
          </div>
          <div
            className="mt-1 w-28 pl-4 pt-60 text-gray-100 max-[600px]:pt-44  
          absolute "
          >
            {episode_baru}
          </div>
    ...
    return (
      <div className="">
        <div className="hover:text-gray-30 flex justify-center cursor-pointer ">
          ...
          <div
            className="mt-1 w-28 pl-3 pt-60 text-gray-100 max-[600px]:pt-44 
          absolute "
          >
